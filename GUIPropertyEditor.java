...
public class GUIPropertyEditor extends javax.swing.JDialog implements ActionListener, KeyListener
{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		else if(e.getSource() == alwaysButton)			// if the new button alwaysButton clicked then the template will be the following
		{
			int curs = propertyText.getCaretPosition();
	...
	private void addActionListeners()
	{
		...
		alwaysButton.addActionListener(this);			//sets action listener in the new button
	}
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
		...
		alwaysButton = new javax.swing.JButton();			//initialize the new alwaysButton
		...
		//sets gui dimensions and properties of the new button inside the jFrame
	...
	//new addition in code ----> always button
